...
abstract class SolutionTest {
    ...
    @Test
    void testD() {
        var input = ClassLoaderUtils
                .getDefaultClassLoader()
                .getResourceAsStream("com/huhu/algorithm/learn/n1838/testD");
        assertNotNull(input);
        int[] nums = new BufferedReader(new InputStreamReader(input))
                .lines()
                .mapToInt(Integer::parseInt)
                .toArray();
        assertEquals(100000, solution.maxFrequency(nums, 100000));
    }
    ...
    void testG() {
        var input = ClassLoaderUtils
                .getDefaultClassLoader()
                .getResourceAsStream("com/huhu/algorithm/learn/n1838/testG");
        assertNotNull(input);
        int[] nums = new BufferedReader(new InputStreamReader(input))
                .lines()
                .mapToInt(Integer::parseInt)
                .toArray();
        assertEquals(29999, solution.maxFrequency(nums, 1));
    }
